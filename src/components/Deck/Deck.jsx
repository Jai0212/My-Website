        ...
        <animated.div
          ...
          <div className='card-content'>
            ...
            {items[i].id === "tools" || items[i].id === "aboutMe" || (items[i].id === "projects" && items[i].centered && isNotMobile) || (items[i].id === "internships" && items[i].centered && isNotMobile) ?
              <p dangerouslySetInnerHTML={{ __html: items[i].description.replace(/\n/g, '<br>') }} style={{ fontSize: !isNotMobile && (items[i].className === 'about-me-description' || items[i].className === "harvard-courses-image" || items[i].className === "google-courses-image" || items[i].className === "aws-courses-image") ? '10px' : '14px' }} /> : <></>}
